...
var PointMap = /*#__PURE__*/function (_BaseShape) {
  _inherits(PointMap, _BaseShape);

  var _super = _createSuper(PointMap);

  function PointMap(points, style) {
  ...
  _createClass(PointMap, [{
    ...
    key: "updateWithNewPoint",
    value: function updateWithNewPoint(points) {
      this.points = points;
      this.update();
    }
  }, {
    ...
    value: function draw() {
      ...
      for (var index = 1; index < this.points.length; index++) {
        ...
        (_this$paint3 = this.paint) === null || _this$paint3 === void 0 ? void 0 : _this$paint3.strokeRect(this.points[index].x, this.points[index].y, 1, 1);
      }
    }
  }]);
